    ...
    <div class="cart_box dropdown-menu dropdown-menu-right">
        ...
        <ul class="cart_list">
            ...
            <li>
                ...
                @endempty
                <span class="cart_quantity"> {{$item->qty}}<span class="cart_amount"> X <span class="price_symbole"></span></span>{{$item->price}} {{ $devise_price }}</span>
            </li>
            @endforeach
        </ul>
        <div class="cart_footer">
            <p class="cart_total"><strong>Subtotal:</strong> <span class="cart_price"> <span class="price_symbole"></span></span>{{Cart::instance('cart')->subtotal()}} {{ $devise_price }}</p>
